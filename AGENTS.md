...
You can run this project with `clickable desktop --no-nvidia`. NEVER try to manually run or compile this application without using clickable, it will never work.
